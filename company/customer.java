...
public class customer<String> extends FileMangerBinary implements Serializable {
    ...
    customer(String fName, String mName, String lName, String phone, String nationalID, String address, int metercode,
            String email, String region, int payment) {
        this.fName = fName;
        this.mName = mName;
        this.lName = lName;
        this.phone = phone;
    ...
    customer(String fName, String phone, String nationalID, String address, int metercode, String email, String region,
            int payment) {
    ...
    public java.lang.String getAddCustomer() {
        return (getFName() + " " + getNationalID() + " " + getmetercode() + " " + getRegion() + " " + getEmail() + " "
                + getPhone() + " " + getpayment() + " " + getpayment());
    }
